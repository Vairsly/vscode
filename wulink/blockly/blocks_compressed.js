...
Blockly.Blocks.lists_create_empty= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.LISTS_CREATE_EMPTY_TITLE,output:"Array",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP,helpUrl:Blockly.Msg.LISTS_CREATE_EMPTY_HELPURL})
}};
...
// };
Blockly.Blocks.lists_create_num= {
	init: function() {
    this.setHelpUrl(Blockly.Msg.LISTS_CREATE_WITH_HELPURL);
	this.setColour(Blockly.Blocks.texts.HUE);
	this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([['整数', 'long'],['小数', 'float'],['字符', 'char']]), "TYPE")
        .appendField(' ')
...
Blockly.Blocks.lists_create_with= {init:
function() {
	this.setHelpUrl(Blockly.Msg.LISTS_CREATE_WITH_HELPURL);
	this.setColour(Blockly.Blocks.texts.HUE);
	this.appendDummyInput("")
...
Blockly.Blocks.lists_create_with_container= {init:
function() {
	this.setColour(Blockly.Blocks.texts.HUE);
...
Blockly.Blocks.lists_create_with_item= {init:
function() {
	this.setColour(Blockly.Blocks.texts.HUE);
...
// Blockly.Blocks.lists_length= {init:
// function() {
// this.jsonInit( {message0:Blockly.Msg.LISTS_LENGTH_TITLE,args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],output:"Number",colour:Blockly.Blocks.lists.HUE,tooltip:Blockly.Msg.LISTS_LENGTH_TOOLTIP,helpUrl:Blockly.Msg.LISTS_LENGTH_HELPURL})
// }};
Blockly.Blocks.lists_isEmpty= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.LISTS_ISEMPTY_TITLE,args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],output:"Boolean",colour:Blockly.Blocks.lists.HUE,tooltip:Blockly.Msg.LISTS_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.LISTS_ISEMPTY_HELPURL})
}};
Blockly.Blocks.lists_indexOf= {init:
function() {
...
Blockly.Blocks.lists_getSublist= {init:
function() {
...
Blockly.Blocks.lists_sort= {init:
function() {
...
Blockly.Blocks.lists_split= {init:
function() {
...
function(a) {"SPLIT"==a?(this.outputConnection.setCheck("Array"),this.getInput("INPUT").setCheck("String")):(this.outputConnection.setCheck("String"),this.getInput("INPUT").setCheck("Array"))
},mutationToDom:
function() {
	var a=document.createElement("mutation");
	a.setAttribute("mode",
...
return {ADD:
        Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD,MINUS:
        Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS,MULTIPLY:
        Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY,DIVIDE:
        Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE,POWER:
		        Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER} [b]
	       })
}
                                };
Blockly.Blocks.math_single= {init:
function() {
this.jsonInit( {message0:"%1 %2",args0:[{type:"field_dropdown",name:"OP",options:[[Blockly.Msg.MATH_SINGLE_OP_ROOT,"ROOT"],[Blockly.Msg.MATH_SINGLE_OP_ABSOLUTE,"ABS"],["-","NEG"],["ln","LN"],["log10","LOG10"],["e^","EXP"],["10^","POW10"],[Blockly.Msg.MATH_TRIG_SIN,"SIN"],[Blockly.Msg.MATH_TRIG_COS,"COS"],[Blockly.Msg.MATH_TRIG_TAN,"TAN"],[Blockly.Msg.MATH_TRIG_ASIN,"ASIN"],[Blockly.Msg.MATH_TRIG_ACOS,"ACOS"],[Blockly.Msg.MATH_TRIG_ATAN,"ATAN"]]},{type:"input_value",name:"NUM",check:"Number"}],output:"Number",colour:Blockly.Blocks.math.HUE,helpUrl:Blockly.Msg.MATH_SINGLE_HELPURL});
	var a=this;
	this.setTooltip(function() {
		var b=a.getFieldValue("OP");
return {ROOT:Blockly.Msg.MATH_SINGLE_TOOLTIP_ROOT,
...
Blockly.Blocks.math_constant= {init:
function() {
this.jsonInit( {message0:"%1",args0:[{type:"field_dropdown",name:"CONSTANT",options:[["\u03c0","PI"],["e","E"],["\u03c6","GOLDEN_RATIO"],["sqrt(2)","SQRT2"],["sqrt(\u00bd)","SQRT1_2"],["\u221e","INFINITY"]]}],output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_CONSTANT_TOOLTIP,helpUrl:Blockly.Msg.MATH_CONSTANT_HELPURL})
}};
Blockly.Blocks.math_number_property= {init:
function() {
...
Blockly.Blocks.math_map= {init:
function() {
this.jsonInit( {message0:"映射 %1 从[ %2 , %3 ]到[ %4 ,%5 ]",args0:[{ "check": "Number", "type": "input_value", "name": "num"},{ "check": "Number", "type": "input_value", "name": "min1"},{ "check": "Number", "type": "input_value", "name": "min2"},{ "check": "Number", "type": "input_value", "name": "max1"},{ "check": "Number", "type": "input_value", "name": "max2"}],output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:"映射函数",helpUrl:"http://haohaodada.com"});
}};
Blockly.Blocks.math_round= {init:
function() {
...
Blockly.Blocks.math_on_list= {init:
function() {
...
return {SUM:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM,MIN:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN,MAX:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX,AVERAGE:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE,MEDIAN:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN,MODE:
        Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE,STD_DEV:
...
function(a) {"MODE"==a?this.outputConnection.setCheck("Array"):this.outputConnection.setCheck("Number")
},mutationToDom:
function() {
	var a=document.createElement("mutation");
...
Blockly.Blocks.math_modulo= {init:
function() {
...
Blockly.Blocks.math_constrain= {init:
function() {
...
Blockly.Blocks.math_random_int= {init:
function() {
...
Blockly.Blocks.math_random_float= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP,helpUrl:Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL})
}};
Blockly.Blocks.variables= {};
Blockly.Blocks.variables.HUE=330;
Blockly.Blocks.variables_get= {init:
function() {
...
Blockly.Blocks.variables_set= {init:
function() {
...
,customContextMenu:
Blockly.Blocks.variables_get.customContextMenu};
Blockly.Blocks.variables_declare= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.variables_declare,args0:[{type:"field_variable",name:"VAR",variable:Blockly.Msg.VARIABLES_DEFAULT_NAME},{ "name": "ioinput", "options": [["整数", "int"], ["长整数", "long"], ["小数", "float"], ["字符", "char"], ["布尔", "boolean"], ["字节", "byte"], ["字符串", "String"]],type:"field_dropdown"},{type:"input_value",name:"VALUE"}],previousStatement:null,nextStatement:null,colour:Blockly.Blocks.variables.HUE,tooltip:Blockly.Msg.VARIABLES_SET_TOOLTIP,helpUrl:Blockly.Msg.VARIABLES_SET_HELPURL});
	this.contextMenuMsg_=Blockly.Msg.VARIABLES_SET_CREATE_GET
                     },contextMenuType_:"variables_get"
,customContextMenu:
Blockly.Blocks.variables_get.customContextMenu};
...
function() {
this.jsonInit( {message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",colour:Blockly.Blocks.colour.HUE,helpUrl:Blockly.Msg.COLOUR_PICKER_HELPURL});
	var a=this;
	this.setTooltip(function() {
		var b=a.getParent();
...
Blockly.Blocks.colour_rgb= {init:
function() {
...
Blockly.Blocks.colour_blend= {init:
function() {
...
function(a) {
	...
	for(var c=0; c<this.arguments_.length; c++) {
		...
		e.setAttribute("vartype",this.argumentstype_[c]);
...
function(a) {
	...
	for(var b=0,c; c=a.childNodes[b]; b++)
		if("arg"==c.nodeName.toLowerCase()){
			...
			this.argumentstype_.push(c.getAttribute("vartype"));
		}
	this.updateParams_();
...
function(a) {
	...
	for(var c=b.getInput("STACK").connection,e=0; e<this.arguments_.length; e++) {
		...
		d.setFieldValue(this.argumentstype_[e], 'TYPEVAR');//新增
		d.oldLocation=e;
		c.connect(d.previousConnection);
		c=d.nextConnection
	  }
...
function(a) {
	...
	for(var b=a.getInputTargetBlock("STACK"); b;)
		this.arguments_.push(b.getFieldValue("NAME")),this.argumentstype_.push(b.getFieldValue("TYPEVAR")),this.paramIds_.push(b.id),b=b.nextConnection&&b.nextConnection.targetBlock();
	this.updateParams_();
	Blockly.Procedures.mutateCallers(this);
	a=a.getFieldValue("STATEMENTS");
	if(null!==a&&(a=
	                  "TRUE"==a,this.hasStatements_!=a))if(a)this.setStatements_(!0),Blockly.Mutator.reconnect(this.statementConnection_,this,"STACK"),this.statementConnection_=null;
		else {
...
var b= {enabled:
	...
	for(var d=0; d<this.arguments_.length; d++)c=
		    goog.dom.createDom("arg"),c.setAttribute("name",this.arguments_[d]),
			c.setAttribute("type",this.argumentstype_[d]),
			e.appendChild(c);
	...
	a.push(b);
if(!this.isCollapsed())for(d=0; d<this.arguments_.length; d++)b= {enabled:
			        !0},c=this.arguments_[d],
					b.text=Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1",c),
					e=goog.dom.createDom("field",null,c),
					e.setAttribute("name","VAR"),e.setAttribute("type","TYPEVAR"),
					e=goog.dom.createDom("block",null,e),e.setAttribute("type","variables_get"),
					b.callback=Blockly.ContextMenu.callbackFactory(this,e),a.push(b)
...
function() {
	...
	.appendField(new Blockly.FieldDropdown([['整数', 'int'], ['长整数', 'long'], ['小数', 'float'], ['布尔', 'boolean'], ['字节', 'byte'], ['字符', 'char'], ['字符串', 'String']]), "TYPE");
	this.setMutator(new Blockly.Mutator(["procedures_mutatorarg"]));
...
updateParams_:
Blockly.Blocks.procedures_defnoreturn.updateParams_,mutationToDom:
Blockly.Blocks.procedures_defnoreturn.mutationToDom,domToMutation:
Blockly.Blocks.procedures_defnoreturn.domToMutation,decompose:
Blockly.Blocks.procedures_defnoreturn.decompose,compose:
Blockly.Blocks.procedures_defnoreturn.compose,getProcedureDef:
function() {
	return[this.getFieldValue("NAME"),this.arguments_,!0]
      },getVars:
Blockly.Blocks.procedures_defnoreturn.getVars,renameVar:
Blockly.Blocks.procedures_defnoreturn.renameVar,
customContextMenu:
Blockly.Blocks.procedures_defnoreturn.customContextMenu,callType_:"procedures_callreturn"
                                     };
Blockly.Blocks.procedures_mutatorcontainer= {init:
function() {
...
Blockly.Blocks.procedures_mutatorarg= {init:
function() {
	var a=new Blockly.FieldTextInput("x",this.validator_);
	
	this.appendDummyInput()
		.appendField(Blockly.Msg.PROCEDURES_MUTATORARG_TITLE)
		.appendField(new Blockly.FieldDropdown([["整数", 'int'], ["长整数", 'long'], ["小数", 'float'], ["布尔", 'boolean'], ["字节", 'byte'], ["字符", 'char'], ["字符串", 'String']]), "TYPEVAR")
        .appendField(a, 'NAME');
	//.appendField(Blockly.Msg.PROCEDURES_MUTATORARG_TITLE).appendField(a,"NAME");
	this.setPreviousStatement(!0);
	this.setNextStatement(!0);
	this.setColour(Blockly.Blocks.procedures.HUE);
...
Blockly.Blocks.procedures_callnoreturn= {init:
function() {
...
Blockly.Blocks.procedures_callreturn= {init:
function() {
...
Blockly.Blocks.procedures_callnoreturn.getProcedureCall,renameProcedure:
Blockly.Blocks.procedures_callnoreturn.renameProcedure,setProcedureParameters_:
Blockly.Blocks.procedures_callnoreturn.setProcedureParameters_,
updateShape_:
Blockly.Blocks.procedures_callnoreturn.updateShape_,mutationToDom:
Blockly.Blocks.procedures_callnoreturn.mutationToDom,domToMutation:
Blockly.Blocks.procedures_callnoreturn.domToMutation,renameVar:
Blockly.Blocks.procedures_callnoreturn.renameVar,onchange:
Blockly.Blocks.procedures_callnoreturn.onchange,customContextMenu:
Blockly.Blocks.procedures_callnoreturn.customContextMenu,defType_:"procedures_defreturn"
                                      };
Blockly.Blocks.procedures_ifreturn= {init:
function() {
...
Blockly.Blocks['text_char'] = {
  ...
  newQuote_: function(open) {
      ...
      var file = 'http://www.haohaodada.com/wulink/static/media/quote2.png';
  
    return new Blockly.FieldImage(file, 7, 12, '"');
  }
};
Blockly.Blocks.text_join= {init:
function() {
this.jsonInit( {message0:"连接文本%1\n%2",args0:[{type:"input_value",name:"ADD0"},{type:"input_value",name:"ADD1"}],output:"String",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_LENGTH_TOOLTIP,helpUrl:Blockly.Msg.TEXT_LENGTH_HELPURL})
}
};
Blockly.Blocks.text_create_join_container= {init:
function() {
	this.setColour(Blockly.Blocks.texts.HUE);
...
Blockly.Blocks.text_create_join_item= {init:
function() {
	this.setColour(Blockly.Blocks.texts.HUE);
...
Blockly.Blocks.text_append= {init:
function() {
...
Blockly.Blocks.text_length= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.TEXT_LENGTH_TITLE,args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],output:"Number",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_LENGTH_TOOLTIP,helpUrl:Blockly.Msg.TEXT_LENGTH_HELPURL})
}};
Blockly.Blocks.text_isEmpty= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.TEXT_ISEMPTY_TITLE,args0:[{type:"input_value",name:"VALUE"}],output:"String",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.TEXT_ISEMPTY_HELPURL})
}};
Blockly.Blocks.text_toint= {init:
function() {
this.jsonInit( {message0:"文本转整数%1",args0:[{type:"input_value",name:"VALUE"}],output:"Number",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.TEXT_ISEMPTY_HELPURL})
}};
Blockly.Blocks.text_indexOf= {init:
function() {
this.jsonInit( {message0:"从文本 %1 寻找第 %2 个出现文本 %3 的位置",args0:[{type:"input_value",name:"VALUE"},{type:"input_value",name:"NUM",check:"Number"},{type:"input_value",name:"FIND"}],output:"Number",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.TEXT_ISEMPTY_HELPURL})
}
};
Blockly.Blocks.text_substring= {init:
function() {
this.jsonInit( {message0:"从文本 %1 寻找第 %2 到第 %3 个子文本",args0:[{type:"input_value",name:"VALUE"},{type:"input_value",name:"NUM",check:"Number"},{type:"input_value",name:"FIND",check:"Number"}],output:"String",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.TEXT_ISEMPTY_HELPURL})
}
};
Blockly.Blocks.text_charAt= {init:
function() {
...
Blockly.Blocks.text_getSubstring= {init:
function() {
...
Blockly.Blocks.text_changeCase= {init:
function() {
...
Blockly.Blocks.text_print= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.TEXT_PRINT_TITLE,args0:[{type:"input_value",name:"TEXT"}],previousStatement:null,nextStatement:null,colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_PRINT_TOOLTIP,helpUrl:Blockly.Msg.TEXT_PRINT_HELPURL})
}};
Blockly.Blocks.text_prompt_ext= {init:
function() {
...
Blockly.Blocks.text_prompt= {init:
function() {
...
Blockly.Blocks.text.newQuote_,updateType_:
Blockly.Blocks.text_prompt_ext.updateType_,mutationToDom:
Blockly.Blocks.text_prompt_ext.mutationToDom,domToMutation:
Blockly.Blocks.text_prompt_ext.domToMutation
                            };
Blockly.Blocks.loops= {};
Blockly.Blocks.loops.HUE=120;
Blockly.Blocks.controls_repeat_ext= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.CONTROLS_REPEAT_TITLE,args0:[{type:"input_value",name:"TIMES",check:"Number"}],previousStatement:null,nextStatement:null,colour:Blockly.Blocks.loops.HUE,tooltip:Blockly.Msg.CONTROLS_REPEAT_TOOLTIP,helpUrl:Blockly.Msg.CONTROLS_REPEAT_HELPURL});
	this.appendStatementInput("DO").appendField(Blockly.Msg.CONTROLS_REPEAT_INPUT_DO)
}};
Blockly.Blocks.controls_repeat= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.CONTROLS_REPEAT_TITLE,previousStatement:null,nextStatement:null,colour:Blockly.Blocks.loops.HUE,tooltip:Blockly.Msg.CONTROLS_REPEAT_TOOLTIP,helpUrl:Blockly.Msg.CONTROLS_REPEAT_HELPURL});
	this.appendStatementInput("DO").appendField(Blockly.Msg.CONTROLS_REPEAT_INPUT_DO)
}};
Blockly.Blocks['controls_repeat1']= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.CONTROLS_REPEAT_TITLE1,colour:Blockly.Blocks.loops.HUE,tooltip:Blockly.Msg.CONTROLS_REPEAT_TOOLTIP1,helpUrl:"http://haohaodada.com"});
	this.appendStatementInput("DO")
}};
Blockly.Blocks.setup= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.setup,colour:Blockly.Blocks.loops.HUE,tooltip:Blockly.Msg.CONTROLS_REPEAT_TOOLTIP1,helpUrl:"http://haohaodada.com"});
	this.appendStatementInput("DO")
}};
Blockly.Blocks.controls_whileUntil= {init:
function() {
...
return {WHILE:
        Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE,UNTIL:
		        Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL} [a]
	       })
}
                                    };
Blockly.Blocks.controls_for= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.CONTROLS_FOR_TITLE,args0:[{type:"field_variable",name:"VAR",variable:null},{type:"input_value",name:"FROM",check:"Number",align:"RIGHT"},{type:"input_value",name:"TO",check:"Number",align:"RIGHT"},{type:"input_value",name:"BY",check:"Number",align:"RIGHT"}],inputsInline:!0,previousStatement:null,nextStatement:null,colour:Blockly.Blocks.loops.HUE,helpUrl:Blockly.Msg.CONTROLS_FOR_HELPURL});
...
Blockly.Blocks.controls_for.customContextMenu
                                 };
Blockly.Blocks.controls_flow_statements= {init:
function() {
...
Blockly.Blocks.controls_if= {init:
function() {
...
Blockly.Blocks.controls_if_if= {init:
function() {
	this.setColour(Blockly.Blocks.logic.HUE);
...
Blockly.Blocks.controls_if_elseif= {init:
function() {
	this.setColour(Blockly.Blocks.logic.HUE);
...
Blockly.Blocks.controls_if_else= {init:
function() {
	this.setColour(Blockly.Blocks.logic.HUE);
...
Blockly.Blocks.logic_compare= {init:
function() {
...
return {EQ:
        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ,NEQ:
        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ,LT:
        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT,LTE:
        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE,GT:
        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT,GTE:
		        Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE} [a]
	       });
...
Blockly.Blocks.logic_operation= {init:
function() {
...
Blockly.Blocks.logic_negate= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.LOGIC_NEGATE_TITLE,args0:[{type:"input_value",name:"BOOL",check:"Boolean"}],output:"Boolean",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.LOGIC_NEGATE_TOOLTIP,helpUrl:Blockly.Msg.LOGIC_NEGATE_HELPURL})
}};
Blockly.Blocks.logic_boolean= {init:
function() {
this.jsonInit( {message0:"%1",args0:[{type:"field_dropdown",name:"BOOL",options:[[Blockly.Msg.LOGIC_BOOLEAN_TRUE,"TRUE"],[Blockly.Msg.LOGIC_BOOLEAN_FALSE,"FALSE"]]}],output:"Boolean",colour:Blockly.Blocks.logic.HUE,tooltip:Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP,helpUrl:Blockly.Msg.LOGIC_BOOLEAN_HELPURL})
}};
Blockly.Blocks.logic_null= {init:
function() {
this.jsonInit( {message0:Blockly.Msg.LOGIC_NULL,output:null,colour:Blockly.Blocks.logic.HUE,tooltip:Blockly.Msg.LOGIC_NULL_TOOLTIP,helpUrl:Blockly.Msg.LOGIC_NULL_HELPURL})
}};
Blockly.Blocks.logic_ternary= {init:
function() {
